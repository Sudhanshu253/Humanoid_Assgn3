Task1: Detecting the moving archery board using color range , mask ,comtour and Press 'S' for shoot command at centre (#hold 'S' for shooting in each frame of video).<br>
